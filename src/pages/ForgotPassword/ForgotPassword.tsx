        ...
        <div className="bg-[#ffffff] rounded-[24px] shadow-xl w-[100%] max-w-[480px] overflow-hidden flex flex-col">
          ...
          <div className="p-[40px] flex flex-col">
            <div className="mb-[32px] text-center">
              <h1 className="text-[32px] leading-[40px] font-[700] text-[#0b1c30] mb-[8px]">Forgot Password</h1>
              <p className="text-[16px] leading-[24px] text-[#444653]">Enter your email to receive a reset link</p>
            </div>
            ...
            <form onSubmit={formik.handleSubmit} className="flex flex-col gap-[24px]">
              ...
              {/* Email Input */}
              <div>
                <label className="block text-[14px] leading-[20px] font-[600] text-[#0b1c30] mb-[8px]">Email Address</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-[16px] flex items-center pointer-events-none">
                    <Mail className="h-[20px] w-[20px] text-[#8f90a6]" />
                  </div>
                  <input
                    type="email"
                    name="email"
                    ...
                    className={`block w-[100%] pl-[48px] pr-[16px] py-[14px] bg-[#f8f9ff] border-[1px] ${formik.touched.email && formik.errors.email ? 'border-[#ff4d4d]' : 'border-[#c4c5d5]'} rounded-[12px] text-[16px] leading-[24px] text-[#0b1c30] placeholder:text-[#8f90a6] focus:outline-none focus:ring-[2px] focus:ring-[#00288e]/20 focus:border-[#00288e] transition-all`}
                  />
                </div>
                {formik.touched.email && formik.errors.email && (
                  <p className="mt-[4px] text-[12px] leading-[16px] text-[#ff4d4d]">{formik.errors.email}</p>
                )}
              </div>
